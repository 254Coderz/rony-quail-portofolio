  ...
  <div class="wrapper">
    ...
    <div class="container">
      ...
      <div v-if="$route.path === '/contact/'">
        <p class="title">A Have A Project in Mind?<br/>Waiting To Hear From You!</p>
        <p class="email-title">ronymarinequail@hotmail.com<br/>(+254)705-0097-84</p>
      </div>
...
<style>
  ...
  .email-title {
    text-align: center;
    font-size: calc(12px + (48 - 14) * ((100vw - 300px) / (1600 - 300)));
    font-weight: bold;
    line-height: 1.25;
